...
#
SHELL=cmd.exe
PATH_TO_IDE_BIN=O:/m/mplab_platform/platform/../mplab_ide/modules/../../bin/
# Adding MPLAB X bin directory to path.
PATH:=O:/m/mplab_platform/platform/../mplab_ide/modules/../../bin/:$(PATH)
# Path to java used to run MPLAB X when this makefile was created
MP_JAVA_PATH="O:\m\sys\java\zulu8.40.0.25-ca-fx-jre8.0.222-win_x64/bin/"
...
DEP_GEN=${MP_JAVA_PATH}java -jar "O:/m/mplab_platform/platform/../mplab_ide/modules/../../bin/extractobjectdependencies.jar"
...
# MP_BC_DIR is not defined
DFP_DIR=O:/m/packs/Microchip/ATmega_DFP/2.3.126
